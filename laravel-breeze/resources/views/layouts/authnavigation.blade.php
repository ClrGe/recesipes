    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('random')" :active="request()->routeIs('random')">
                        {{ __('Recette au hasard') }}
                    </x-nav-link>
                </div>
            ...
            <div class="hidden space-x-4 sm:flex sm:items-center sm:ml-6">
                ...
                <div class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">
                    <a href="/register"> {{ __('Inscription') }} </a>
                </div>
            </div>
