...
<header>
    <div class="menu">
        <ul class="top-nav">
            <div>
                <a href="#" class="logo"><img src="logo_cube_web_mobile.png" alt="recesipes"></a>
            </div>
            <div class="nav-all">
            ...
            <div class="elements-right">
                ...
                <li class="connect">
                    <a href="#" class="active">🧁 S'identifier</a>
                </li>
            </div>
        </ul>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\CESI\CUBES\Cubes_Web_Mobile\Git\recesipes\laravel-sail\resources\views/contact.blade.php ENDPATH**/ ?>